<?php
	...
	$class = $width;
	$class = montserrat_ninzio_column_convert($class);
	...
	$output .= '<div class="col '.$width.' '.$class.' '.sanitize_html_class($extra_class).' element-animate-'.$animate.' valign-'.sanitize_html_class($valign).'" style="'.$col_styles.'" data-effect="'.sanitize_html_class($effect).'" data-align="'.esc_attr($text_align).'" '.$margin_b.'>';
