           ...
           if($depth != 0)
           {
            ...
            $item_output .= '<a'. $attributes .'>';
              ...
              if (! empty( $item->ltext )) {
                ...
                $montserrat_ninzio_color    = ($GLOBALS['montserrat_ninzio']['main-color']) ? $GLOBALS['montserrat_ninzio']['main-color'] : "#dc3522";
                $label_color = (! empty( $item->lcolor )) ? esc_attr($item->lcolor) : $montserrat_ninzio_color; 
