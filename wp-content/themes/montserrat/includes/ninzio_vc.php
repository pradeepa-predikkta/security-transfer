<?php
	...
	/*-------------------------------*/
		...
		vc_add_param('vc_column', array(
			...
			"value"      => array(
				...
				"Ghost-right" => 'ghost-right',
				"Fade-left-Bounce"   => 'fade-left-bounce',
				"Fade-right-Bounce"  => 'fade-right-bounce',
				"Ghost-left-Bounce"  => 'ghost-left-bounce',
				"Ghost-right-Bounce" => 'ghost-right-bounce',
				"Scale"       => 'scale',
		...
		vc_add_param('vc_column', array(
			"type"       => "dropdown",
			"class"      => "",
			"heading"    => "Vertical align (available only if parent row autoheight is activated)",
			"param_name" => "valign",
			"value"      => array(
				"Top"    => 'top',
				"Middle" => 'middle',
	...
	if (defined( 'NINZIO_ADDONS' ) && file_exists( get_template_directory() . '/plugins/ninzio-addons.zip' ) ) {
		add_action( 'init', 'montserrat_ninzio_integrateVC');
	    function montserrat_ninzio_integrateVC() {
			...
			/*-------------------------------*/
		    	...
		    	vc_map(array(
		    		...
		    		'category'                => esc_html__("Ninzio",'montserrat'),
		    		'icon'                    => 'icon-button',
		    		'js_view'                 => '',
		    		...
		    		'params'                  => array(
		    			...
		    			array(
							...
							"value"      => array(
								...
								"large"                  => 'large',
								"full size"              => 'full',
								"ninzio-half"            => 'Montserrat-Ninzio-Half',
								"ninzio-one-third"       => 'Montserrat-Ninzio-One-Third',
								"ninzio-three-quarters"  => 'Montserrat-Ninzio-Three-Quarters',
								"ninzio-whole"           => 'Montserrat-Ninzio-Whole'
							)
						),
						array(
							"type"       => "dropdown",
		    		...
		    		'params'                  => array(
						...
						array(
							...
							"value"      => array(
								"thumbnail"              => 'thumbnail',
								"medium"                 => 'medium',
								"ninzio-uni"             => 'Montserrat-Ninzio-Half',
								"ninzio-half"            => 'Montserrat-Ninzio-Half',
								"ninzio-one-third"       => 'Montserrat-Ninzio-One-Third',
							),
				...
				vc_map(array(
		    		...
		    		'params'                  => array(
						...
						array(
							...
							"dependency" => Array('element' => "version", 'value' => 'version1')
						),
				...
				vc_map(array(
		    		...
		    		'params'                  => array(
						...
						array(
							...
							"heading"    => "Box content",
							"param_name" => "content",
							"value"      => '<p>Box content goes here</p>',
						)
		    		)
		    	));
	    ...
	    if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
		    ...
		    class WPBakeryShortCode_nz_Steps extends WPBakeryShortCodesContainer {}
