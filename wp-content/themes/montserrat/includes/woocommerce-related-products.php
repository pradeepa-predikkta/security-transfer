...
<?php if ($nz_shop_rp == "true"): ?>
	<?php
		$posts_number = ($GLOBALS['montserrat_ninzio']['shop-rpn']) ? $GLOBALS['montserrat_ninzio']['shop-rpn'] : 4;
	...
	<?php if ($terms): ?>
		...
		<?php if ($related_products->have_posts()): ?>
			<div class="nz-related-products column-<?php echo esc_attr($posts_number); ?>">
				<div class="related-products-title"><h3><?php echo esc_html__('Related products', 'montserrat'); ?></h3></div>	
