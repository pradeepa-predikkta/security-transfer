...
?>
<!-- content start -->
<div id="nz-content" class='content nz-clearfix padding-<?php echo esc_attr($nz_padding); ?>'>
	<div class='container <?php echo esc_attr($nz_page_width); ?>'>
		<?php if($nz_sidebar_pos == "left"): ?>
				...
				<div class="main-content right">
					...
					<?php if ($GLOBALS['montserrat_ninzio']['page-comments'] && $GLOBALS['montserrat_ninzio']['page-comments'] == 1): ?>
