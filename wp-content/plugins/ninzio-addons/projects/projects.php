<?php
	...
	function ninzio_addons_projects() {
		...
		$slug          = (isset($GLOBALS['montserrat_ninzio']['projects-slug']) && !empty($GLOBALS['montserrat_ninzio']['projects-slug'])) ? esc_attr($GLOBALS['montserrat_ninzio']['projects-slug']) : 'projects';
	...
	function ninzio_addons_projects_taxonomies() {
		...
		global $montserrat_ninzio;
		$category_slug     = (isset($GLOBALS['montserrat_ninzio']['projects-cat-slug']) && !empty($GLOBALS['montserrat_ninzio']['projects-cat-slug'])) ? esc_attr($GLOBALS['montserrat_ninzio']['projects-cat-slug']) : 'projects-category';
		$tag_slug          = (isset($GLOBALS['montserrat_ninzio']['projects-tag-slug']) && !empty($GLOBALS['montserrat_ninzio']['projects-tag-slug'])) ? esc_attr($GLOBALS['montserrat_ninzio']['projects-tag-slug']) : 'projects-tag';
...
/*====================================================================*/
	...
	function ninzio_addons_projects_custom_columns($column){
		...
		$montserrat_ninzio_projects_format = isset($values["format"][0]) ? $values["format"][0] : "image";
