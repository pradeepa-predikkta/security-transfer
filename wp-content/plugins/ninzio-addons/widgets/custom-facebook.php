<?php 
	...
	add_action('widgets_init', 'ninzio_addons_register_facebook_like_widget');
	function ninzio_addons_register_facebook_like_widget(){
		register_widget( 'Ninzio_Addons_WP_Widget_Facebook_Like_Box' );
	} 

	class Ninzio_Addons_WP_Widget_Facebook_Like_Box extends WP_Widget {

		public function __construct() {
			parent::__construct(
				'facebook',
				esc_html__('* Facebook Like Box', 'ninzio-addons'),
				array( 'description' => esc_html__('Facebook Like Box widget', 'ninzio-addons'))
			);
		}
		...
		public function widget( $args, $instance ) {
	 	...
	 	public function form( $instance ) {
	 		...
	 		$defaults = array(
	 			'title'       => esc_html__('Find us on Facebook', 'ninzio-addons'),
	 			'href'        => '',
	 			'app_id'      => '',
	 			'show_faces'  => 'on',
	 			'show_border' => 'on',
			...
			<p>
				<label for="<?php echo $this->get_field_id('href'); ?>"><?php echo esc_html__( 'Facebook Page URL:', 'ninzio-addons' ); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('app_id'); ?>"><?php echo esc_html__( 'App ID from the app dashboard:', 'ninzio-addons' ); ?></label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_faces'); ?>"><?php echo esc_html__( 'Show faces', 'ninzio-addons' ); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_border'); ?>"><?php echo esc_html__( 'Show border', 'ninzio-addons' ); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('stream'); ?>"><?php echo esc_html__( 'Show stream', 'ninzio-addons' ); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('header'); ?>"><?php echo esc_html__( 'Show facebook header', 'ninzio-addons' ); ?></label>
			</p>
			<?php
		}
