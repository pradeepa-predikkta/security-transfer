...
add_action('widgets_init', 'ninzio_adddons_register_twitter_widget');
function ninzio_adddons_register_twitter_widget(){
...
class  Ninzio_Addons_WP_Widget_Twitter extends WP_Widget {
	...
	public function widget($args, $instance){
		...
		$consumer_key        = ($montserrat_ninzio['tweets-consumer-key']) ? esc_attr($montserrat_ninzio['tweets-consumer-key']): "";
		$consumer_secret     = ($montserrat_ninzio['tweets-consumer-secret']) ? esc_attr($montserrat_ninzio['tweets-consumer-secret']) : "";
		$access_token        = ($montserrat_ninzio['tweets-access-token']) ? esc_attr($montserrat_ninzio['tweets-access-token']) : "";
		$access_token_secret = ($montserrat_ninzio['tweets-access-token-secret']) ? esc_attr($montserrat_ninzio['tweets-access-token-secret']) : "";
