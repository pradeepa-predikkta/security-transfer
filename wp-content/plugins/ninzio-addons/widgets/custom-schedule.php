<?php
	...
	add_action('widgets_init', 'ninzio_addons_register_schedule_widget');
	function ninzio_addons_register_schedule_widget(){
		register_widget( 'Ninzio_Addons_WP_Widget_Schedule' );
	}

	class  Ninzio_Addons_WP_Widget_Schedule extends WP_Widget {

		public function __construct() {
			parent::__construct(
				'schedule',
				esc_html__('* Schedule', 'ninzio-addons'),
				array( 'description' => esc_html__('Schedule Form', 'ninzio-addons'))
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			$output .='<div class="nz-schedule">';
				$output .= '<ul>';
					$output .= '<li class="nz-clearfix"><div class="day">'.esc_html__('Monday', 'ninzio-addons').'</div><div class="hours">'.$mo.'</div></li>';
					$output .= '<li class="nz-clearfix"><div class="day">'.esc_html__('Tuesday', 'ninzio-addons').'</div><div class="hours">'.$tu.'</div></li>';
					$output .= '<li class="nz-clearfix"><div class="day">'.esc_html__('Wednesday', 'ninzio-addons').'</div><div class="hours">'.$we.'</div></li>';
					$output .= '<li class="nz-clearfix"><div class="day">'.esc_html__('Thursday', 'ninzio-addons').'</div><div class="hours">'.$th.'</div></li>';
					$output .= '<li class="nz-clearfix"><div class="day">'.esc_html__('Friday', 'ninzio-addons').'</div><div class="hours">'.$fr.'</div></li>';
					$output .= '<li class="nz-clearfix"><div class="day">'.esc_html__('Saturday', 'ninzio-addons').'</div><div class="hours">'.$sa.'</div></li>';
					$output .= '<li class="nz-clearfix"><div class="day">'.esc_html__('Sunday', 'ninzio-addons').'</div><div class="hours">'.$su.'</div></li>';
				$output .= '</ul>';
			$output .='</div>';
			$output .= $after_widget;
			echo $output;
	 	...
	 	public function form( $instance ) {
			...
			$defaults = array(
	 			'title'       => esc_html__('Schedule', 'ninzio-addons'),
	 			'mo'      => '',
	 			'tu'      => '',
	 			'we'      => '',
	 			'th'      => '',
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'mo' ); ?>"><?php echo esc_html__( 'Monday:', 'ninzio-addons' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'tu' ); ?>"><?php echo esc_html__( 'Tuesday:', 'ninzio-addons' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'we' ); ?>"><?php echo esc_html__( 'Wednesday:', 'ninzio-addons' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'th' ); ?>"><?php echo esc_html__( 'Thursday:', 'ninzio-addons' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'fr' ); ?>"><?php echo esc_html__( 'Friday:', 'ninzio-addons' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'sa' ); ?>"><?php echo esc_html__( 'Saturday:', 'ninzio-addons' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'su' ); ?>"><?php echo esc_html__( 'Sunday:', 'ninzio-addons' ); ?></label> 
